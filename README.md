...
reports/           Python package + report templates
  ...
  ├── build.py     Report registry (full-cv, publicaciones_html, …)
...
python -m reports generate publicaciones_html [--from ...] [--to ...]
...
| `publicaciones_html` | `reports/publicaciones_html/html/` | — (HTML) | jivg.org publications |
...
│   ├── short_cv/         Short CV
│   ├── publicaciones_html/  HTML output
