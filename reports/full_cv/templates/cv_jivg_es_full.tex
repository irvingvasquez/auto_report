...
\textbf{Divulgación \faYoutube:} \url{https://www.youtube.com/@IrvingVasquez}\\
\end{minipage}
...
\end{minipage}
\begin{minipage}{4.5in}
	\textbf{Profesor invitado.} Escuela Superior de Cómputo (ESCOM).\\ 
\end{minipage}
...
\end{minipage}
\begin{minipage}{4.5in}
	\textbf{Profesor titular C.} Centro de Innovación y Desarrollo Tecnológico en Cómputo (CIDETEC). Instituto Politécnico Nacional (IPN).\\ 
\end{minipage}
...
\end{minipage}
\begin{minipage}{4.5in}
	\textbf{Cátedra CONACyT} asignado al Instituto Politécnico Nacional (IPN). Proyecto 1507.\\ 
\end{minipage}
...
\begin{itemize}
	...
	\item \textbf{Artículos en revistas científicias:}
	\input{../text/otros.tex}
\end{itemize} 
...
\hrule
\begin{itemize}
	\item \textbf{Proyectos externos.}
	\input{../text/projects.tex}
	\item \textbf{Desarrollos tecnológicos validados por la comisión transversal de tecnología del SNI.}
