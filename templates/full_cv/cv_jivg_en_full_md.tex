...
\quote{``Soy un investigador científico apasionado por comprender los algoritmos que involucran la interacción de la visión computacional con la robótica. Mi formación como científico e ingeniero en computación me ha permitido investigar analíticamente los algoritmos involucrados así como llevar llevarlos a la solución de problemas prácticos. Mis intereses actuales de investigación son la visión basada en aprendizaje profundo, la planificación de trayectorias en robots móviles y la exploración/reconstrucción autónoma de ambientes u objetos."}                                 % optional, remove/comment the line if not wanted
%
\begin{document}
%-----       resume       ---------------------------------------------------------
\makecvtitle
